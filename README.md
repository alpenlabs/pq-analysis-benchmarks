...
proof, its circuit hash and preprocessed root). Gate counts are per verification under the Boolean cost model
...
hash replaced by BLAKE3. The last row is the baseline: g16ckt's Groth16
